...
public class ArchiveExtractCallback implements IArchiveExtractCallback // , ICryptoGetTextPassword,
{
        ...
        switch (askExtractMode) {
            ...
            case IInArchive.NExtract_NAskMode_kExtract:
                ...
                try {
                    ...
                    String outFile = _diskFilePath + "/" +_filePath;
                    
                    java.io.RandomAccessFile outStr = new java.io.RandomAccessFile(outFile,"rw");
    ...
    // extract to provided dir
    public void Init(SevenZip.Archive.IInArchive archiveHandler, String diskFilePath) {
        _archiveHandler = archiveHandler;
        _diskFilePath = diskFilePath;
        new File(diskFilePath).mkdirs();
    }
